...
1. Video uploaded on [YouTube](https://youtu.be/gNPmMvQVf5Q) and [Bilibili](https://www.bilibili.com/video/av56593404)
2. [Tool package](https://github.com/sheetguard/sguard/archive/v1.0.zip) released for public access, whose execution details are below
3. [SGuard homepage](https://sheetguard.github.io/sguard) generated by GitHub Pages
...
We release our SGuard's obfuscated version named "SGuardGUI-obf.jar", which can be executed with a command "java -jar SGuardGUI-obf.jar". Before executing this command, please download all files in the [sguard/tools](https://github.com/sheetguard/sguard/tree/master/tools) directory, especially those DLL files. Besides, we add two test files in [sguard/tools/TestCases](https://github.com/sheetguard/sguard/tree/master/tools/TestCases) directory. Have fun with our tool!
...
SGuard's demonstration has already accepted by [ASE 2019 Demonstrations Track](https://2019.ase-conferences.org/track/ase-2019-Demonstrations), and this tool itself builds on our previous work, [CUSTODES](https://dl.acm.org/citation.cfm?id=2884796) (ICSE16) and [WARDER](https://cs.nju.edu.cn/changxu/1_publications/QRS19.pdf) (QRS19). For further information about CUSTODES, you can visit another [website](http://sccpu2.cse.ust.hk/custodes/).
